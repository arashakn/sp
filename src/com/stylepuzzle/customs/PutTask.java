...
public class PutTask extends AsyncTask<Void, Void, String>{
	...
	public PutTask(Context con, String dv, String urlRequest, OnFinishPosting ofuploading,String eKey){
		cont = con;
	...
	protected String doInBackground(Void... params) {
		try {
			...
			HttpPut httpPut = new HttpPut(webAddressToPost);
			System.out.println("-------------->"+webAddressToPost);
			StringEntity entity = new StringEntity(dataValue, HTTP.UTF_8);
			entity.setContentType("application/json");
			httpPut.setEntity(entity);
			httpPut.addHeader("Authorization", "Token "+AppController.spTokken);
			httpPut.setEntity(entity);
