...
@SuppressLint("NewApi") 
public class FashionistaTabPage extends BaseFragmentActivity implements ActionBar.TabListener {
	...
	private Response.Listener<String> createMyReqSuccessListener() {
		return new Response.Listener<String>() {
			...
			public void onResponse(String response) {
				...
				System.out.println("--------->"+fashionistaList.getResult().size());
			}
		};
	}
        ...
        public Fragment getItem(int i) {
            switch (i) {
                case 0:
                    ...
                    return new ListFragmentFashionistaOrders();
